    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM анализирует содержимое документов и требования к симуляции, извлекает реальные данные и автоматически формирует структуру онтологии
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            На основе сгенерированной онтологии документы автоматически разбиваются на блоки, Zep строит граф знаний, извлекает сущности и связи, формирует временную память и сводки сообществ
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Типов в схеме</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Граф знаний построен. Перейдите к следующему шагу для настройки среды симуляции.</p>
          <button 
            class="action-btn" 
...
// Переход к настройке среды — создаём simulation и переходим
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      // Переходим на страницу simulation
      router.push({
        name: 'Simulation',
