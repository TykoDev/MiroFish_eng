          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Диалог с агентом мира' }}</span>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Быстрый диалог с агентом отчётов. 4 профессиональных инструмента, полная память MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Сопоставление seed-данных реального мира с состоянием симуляции. Глубокий каузальный анализ через Global/Local Memory</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch - Полный обзор</div>
                    <div class="tool-desc">Алгоритм обхода графа в ширину. Реконструкция путей распространения событий</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Мгновенные запросы через GraphRAG для быстрого извлечения атрибутов узлов и фактов</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Автономные интервью: параллельные многораундовые диалоги с агентами мира для сбора мнений</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">О себе</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Задайте вопрос Report Agent о содержании отчёта' : 'Пообщайтесь с агентами мира, узнайте их мнение' }}
              </p>
            </div>
            <div 
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Выбрать собеседника: ${agent.username}`)
}
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Сначала выберите агента мира')
  }
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'Вы' : '你'}：${msg.content}`)
      .join('\n')
...
const submitSurvey = async () => {
  ...
  addLog(`Отправить опрос给 ${selectedAgents.value.size} респондентам...`)
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    addLog(`Ошибка загрузки логов: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Загружено ${profiles.value.length} агентов мира`)
    }
  } catch (err) {
...
// Lifecycle
onMounted(() => {
  addLog('Step5 Инициализация взаимодействия')
  loadReportData()
  loadProfiles()
