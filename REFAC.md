...
3. **Consistency:** Keep phrasing consistent across the application. E.g., if translating "Analysis" as "Analyze", stick to "Analyze" in all similar contexts instead of mixing with "Examine".
