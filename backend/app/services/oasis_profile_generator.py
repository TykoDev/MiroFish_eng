...
"""
            ...
            try:
                ...
                try:
                    ...
                    if "persona" not in result or not result["persona"]:
                        result["persona"] = entity_summary or f"{entity_name}EnText{entity_type}X"
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        persona = persona_match.group(1) if persona_match else (entity_summary or f"{entity_name}EnText{entity_type}X")
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        ...
        base_prompt = "You are an expert in generating social media user portraits. Generate detailed and realistic personas for public opinion simulation, and restore existing reality to the greatest extent. Valid JSON format must be returned, and all string values XXcannot contain unescaped newlines. Use Chinese."
        return base_prompt
