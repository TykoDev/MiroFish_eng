...
from .lightrag_entity_reader import EntityReader as ZepEntityReader, FilteredEntities
...
class SimulationStatus(str, Enum):
    ...
    RUNNING = "running"
    PAUSED = "paused"
    STOPPED = "stopped"      # Simulation is stopped manually
    COMPLETED = "completed"  # Simulation is completed naturally
    FAILED = "failed"
...
"""
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No entities matching the criteria were found, please check whether the graph is constructed correctly"
                self._save_simulation_state(state)
                return state
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                ...
                f" - Run Twitter alone: XXpython {scripts_dir}/run_twitter_simulation.py --config {config_path}\n"
                f" - Run Reddit alone: XXpython {scripts_dir}/run_reddit_simulation.py --config {config_path}\n"
