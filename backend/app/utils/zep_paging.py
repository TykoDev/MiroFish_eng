...
def _fetch_page_with_retry(
    ...
    **kwargs: Any,
    ...
    """Single page request, exponential backoff retry on failure. Only network/IO transient errors are retried."""
    if max_retries < 1:
...
def fetch_all_nodes(
    ...
    """Get graph nodes in pages, returning max_items at most (default 2000). Each page request comes with a retry."""
    all_nodes: list[Any] = []
