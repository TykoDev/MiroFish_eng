...
INTERVIEW_PROMPT_PREFIX = "Combine your character, all past memories and actions, and reply to me directly with text without using any tools:"
...
"""
    ...
    try:
        ...
        # Check if preparation is complete (to avoid repeated generation)
        ...
        try:
            ...
            filtered_preview = reader.filter_defined_entities(
                ...
                enrich_with_edges=False  # Do not obtain side information and speed up
            )
...
"""
    try:
        ...
        if state.status != SimulationStatus.READY:
            # Check whether the preparation work has been completed
            is_prepared, prepare_info = _check_simulation_prepared(simulation_id)
        ...
        if not os.path.exists(db_path):
            return jsonify({
                ...
                "data": {
                    ...
                    "count": 0,
                    "posts": [],
                    "message": "The database does not exist and the simulation may not have been run yet"
                }
            })
