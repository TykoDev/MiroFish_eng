...
"""
    try:
        ...
        if not graph_id:
            return jsonify({
                "success": False,
                "error": "Map ID missing, please ensure the map has been built"
            }), 400
        ...
        return jsonify({
            ...
            "data": {
                ...
                "task_id": task_id,
                "status": "generating",
                "message": "The report generation task has been started, please query the progress through /api/report/generate/status",
